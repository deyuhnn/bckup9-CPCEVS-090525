          ...
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-lg relative max-h-[90vh] overflow-hidden">
            ...
            {success ? (
              ...
              <form className="px-8 py-6 space-y-4 overflow-y-auto max-h-[65vh]" onSubmit={handleSubmit}>
                <div>
                  <label className="block text-sm font-semibold text-blue-900">ID NUMBER:</label>
                  <input
                    type="number"
                    name="idNumber"
                    value={form.idNumber}
                ...
                <div>
                  <label className="block text-sm font-semibold text-blue-900">COURSE:</label>
                  <select
                    name="course"
                    value={form.course}
                    onChange={handleChange}
                ...
                <div>
                  <label className="block text-sm font-semibold text-blue-900">BIRTHDAY:</label>
                  <input
                    type="date"
                    name="birthday"
                    value={form.birthday}
                ...
                <div>
                  <label className="block text-sm font-semibold text-blue-900">MESSAGE:</label>
                  <textarea
                    name="message"
                    value={form.message}
                    onChange={handleChange}
                ...
                {/* File Upload */}
                <div className="pt-2">
                  <p className="text-xs text-gray-500 text-center mb-2">PLEASE ATTACH YOUR ID PHOTO FOR VERIFICATION</p>
                  <div className="flex items-center justify-center">
                    <label className="cursor-pointer flex items-center gap-2 bg-blue-100 hover:bg-blue-200 px-4 py-2 rounded-lg transition">
                       Image
